...
- Show a 'Get my offer' button
## Phase: Review offer
- Get the final offer and show the price in euros 
- Also show a summary of responses
- Show a 'Start again' button
- Say it may take up to 3 minutes to get the offer
- Show an animated gif while waiting for getting the final offer
- If it takes long apologize and say we are working hard to get your offer 
